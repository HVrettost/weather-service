...
class DeleteApiCallMetricsByApiCallTypeRequest implements TestRequest{

    private TestRestTemplate restTemplate
    private String url = '%s/api/test/api-call-metrics/%s'

    DeleteApiCallMetricsByApiCallTypeRequest(TestRestTemplate testRestTemplate, ApiCallType apiCallType) {
