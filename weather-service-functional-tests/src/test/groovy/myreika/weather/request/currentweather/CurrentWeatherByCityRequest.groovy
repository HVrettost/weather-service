...
class CurrentWeatherByCityRequest implements Request {

    private TestRestTemplate restTemplate
    private String url = '%s/api/weather/current/city/%s'

    CurrentWeatherByCityRequest(TestRestTemplate testRestTemplate, String city, def units = null, def language = null) {
        this.restTemplate = testRestTemplate
        url = String.format(url, HOST, city)
