...
import myreika.weather.dto.current.CloudsInfoDto;
import myreika.weather.dto.current.CoordinatesDto;
import myreika.weather.dto.current.MainInfoDto;
import myreika.weather.dto.current.GeneralInfoDto;
import myreika.weather.dto.current.RainDto;
import myreika.weather.dto.current.SnowDto;
import myreika.weather.dto.current.WeatherDescriptionDto;
import myreika.weather.dto.current.PrecipitationDto;
import myreika.weather.dto.current.WindInfoDto;
import myreika.weather.dto.current.LastUpdateDto;
